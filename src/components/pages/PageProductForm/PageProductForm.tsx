  ...
  return (
    <form onSubmit={handleSubmit} autoComplete="off">
      <Grid container spacing={2}>
        ...
        <Grid item xs={12}>
          <Field component={TextField} name="description" label="Description" fullWidth autoComplete="off" multiline required />
        </Grid>
        <Grid item xs={12} sm={4}>
          <Field component={TextField} name="sole" label="Sole" fullWidth autoComplete="off" required />
        </Grid>
        <Grid item xs={12} sm={4}>
          <Field component={TextField} name="last" label="Last" fullWidth autoComplete="off" required />
        </Grid>
        <Grid item xs={12} sm={4}>
        ...
        <Grid item xs={12} sm={4}>
          <Field component={TextField} name="image_url" label="Image URL" fullWidth autoComplete="off" />
        </Grid>
